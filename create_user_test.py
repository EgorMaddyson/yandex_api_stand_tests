...
# Тест 3. Успешное не создание пользователя
# Параметр fisrtName состоит из 1 символов
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")


# Тест 4. Успешное не создание пользователя
...
# Параметр fisrtName состоит из кириллицы символов

def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Мария")


# Тест 7. Успешное не создание пользователя
# Параметр fisrtName состоит из символов с пробелами
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")


# Тест 8. Успешное не создание пользователя
# Параметр fisrtName состоит из спецсимволов
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("№%@")


# Тест 9. Успешное не создание пользователя
# Параметр fisrtName состоит из цифр
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")


# Тест 10. Успешное не создание пользователя
...
# Тест 11. Успешное не создание пользователя
# Параметр fisrtName передано пустое значение
...
# Тест 12. Успешное не создание пользователя
# Параметр fisrtName состоит из другой тип параметра
